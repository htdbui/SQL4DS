...
<table>
    <caption>Table 5.2</caption>
    <thead>
        <tr>
            <th>product_id</th>
            <th>product_name</th>
            <th>product_prod_cat_id</th>
            <th>category_prod_cat_id</th>
            <th>product_category_name</th>
        </tr>
    </thead>
    <tbody>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>Eggs</td>
            <td>6</td>
            <td>Eggs & Meat (Fresh or Frozen)</td>
        </tr>
        <tr>
            <td>11</td>
            <td>Pork Chops</td>
